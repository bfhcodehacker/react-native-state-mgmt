...
import { MobXTodoType } from '../stores/mobXStore';

interface MobXTodoListItemProps {
  todo: MobXTodoType;
  toggleChecked: (todo: MobXTodoType) => void;
  deleteTodo: (todo: MobXTodoType) => void;
}

export const MobXTodoListItem: FC<MobXTodoListItemProps> = props => {
